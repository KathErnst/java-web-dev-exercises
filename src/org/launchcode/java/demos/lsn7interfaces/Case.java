...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("Fudge", .15, new ArrayList<>(Arrays.asList("dairy", "gluten")));
        Topping topping2 = new Topping("Peanuts", .25, new ArrayList<>(Arrays.asList("peanuts")));
        Topping topping3 = new Topping("Chocolate Chips", .15, new ArrayList<>(Arrays.asList("dairy", "gluten")));
